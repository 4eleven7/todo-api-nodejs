...
module.exports = (function (io) {
  return {
      ...
      if (typeof title === 'undefined' || title.length === 0) {
        ...
        Todo.create({
          ...
          filterTodo(todo, function(err, todo) {
            ...
            io.sockets.emit('created-todo', {todo: todo});
            return next();
          });
        });
      }
      ...
      if (typeof title === 'undefined' || title.length === 0) {
        ...
        Todo.findOneAndUpdate({
          ...
          filterTodo(todo, function(err, todo) {
            ...
            io.sockets.emit('updated-todo', {todo: todo});
            return next();
          });
        });
      }
    ...
    completed: function completed(req, res, next){
      var id               = req.params.id;
      ...
      if (typeof completed === 'undefined') {
        ...
        Todo.findOneAndUpdate({
          ...
          io.sockets.emit(response_message + '-todo', {id: todo.uuid});
          return next();
        });
      }
    },
    ...
    destroy: function destroy(req, res, next) {
      ...
      Todo.findOneAndRemove({uuid: id}, function(err, todo){
        if (err) {
          ...
          io.sockets.emit('destroyed-todo', {id: todo.uuid});
          return next();
        }
      });
    }
